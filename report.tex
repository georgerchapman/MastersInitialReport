...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% What IS quantum mechanics and why is it unlikely to view it at a macroscopic scale
Quantum mechanics is the statistical theory that governs the interactions between systems on the nanometre level.
% The theory results in the non-intuitive quantisation of familiar quantities, such as energy and momentum.
It is therefore unexpected to observe these effects at the macroscopic level.

% QM in birds for navigation \cite{11}
...
% Coherence of electrons in photosynthesis \cite{11,14}
...
% Quantum mechanical effects from walkers an the scope of this project
